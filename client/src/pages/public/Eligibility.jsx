...
const Eligibility = () => {
  return (
    <div>
      <PageHeader title="Eligibility" subtitle="Eligibility and Documents Required for Used Car Loan" />
      ...
      <section className="py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <ul className="list-disc pl-5 text-gray-600 mt-3 space-y-2">
            <li>Photo Identity Proof documents – Voter’s ID/Passport/PAN Card/Driving License/Aadhaar Card</li>
            <li>Income proof of latest salary slip/form16/ last 3 months bank statements</li>
            <li>Address Proof documents – Ration Card/Electricity Bill/Passport, Copy of Utility Bill/Bank Statements/Property Registration documents/Property Tax Receipt</li>
...
const Tabs = () => {
  ...
  return (
    <div>
        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`px-4 py-2 text-sm font-semibold ${
              activeTab === tab.key ? 'border-b-2 border-primary text-primary' : 'text-gray-600'
            }`}
      ...
      <div className="mt-4 text-gray-700">{activeContent}</div>
    </div>
  );
};
